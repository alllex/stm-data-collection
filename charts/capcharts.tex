...
\pgfplotstableread{pq-bench-period500-s50000-r50.log}\pqthr
\pgfplotstableread{pq-bench-timing100000-s50000-r50.log}\pqtim
\pgfplotstableread{bag-bench-period500-s50000-r50.log}\bagthr
\pgfplotstableread{bag-bench-timing100000-s50000-r50.log}\bagtim
...
\begin{document}
  ...
  \section{Priority Queue Throughput}
    ...
    Initial size = 50000 items. Insertion rate = 50\%. Period = 500ms.
    \newline

  \begin{tikzpicture}
    \begin{axis} [
        width=0.8\textwidth, xtick=data, ytick=data,
        xlabel=Number of capabilities, ylabel=Completed operations
    ]
  ...
  \section{Priority Queue Timing}
    ...
    Initial size = 50000 items. Insertion rate = 50\%. Amount of operations = 100000.
    \newline

  \begin{tikzpicture}
    \begin{axis} [
        width=0.8\textwidth, xtick=data, ytick=data,
        xlabel=Number of capabilities, ylabel=Time (ms)
    ]
    \addplot+ [ error bars/.cd, y dir=both, y explicit ]
